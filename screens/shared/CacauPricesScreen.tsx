...
export default function CacauPricesScreen() {
  ...
  const fetchPrices = useCallback(async (showRefresh = false) => {
    try {
      ...
      setError('Nao foi possivel carregar os precos. Verifique sua conexao.');
      console.error('[CacauPrices] Error:', err);
    } finally {
      setLoading(false);
      setRefreshing(false);
    }
      ...
      <View style={styles.container}>
          ...
          <View style={[styles.emptyCard, { backgroundColor: colors.card }]}>
            ...
            <ThemedText style={[styles.emptyText, { color: colors.textSecondary }]}>
              {selectedCity !== 'all' 
                ...
                : 'Aguardando primeiros registros de precos'}
            </ThemedText>
          </View>
        ) : (
        ...
        <View style={[styles.infoCard, { backgroundColor: colors.backgroundSecondary }]}>
          ...
          <ThemedText style={[styles.infoText, { color: colors.textSecondary }]}>
            Precos informados pela comunidade. Os valores podem variar conforme qualidade e quantidade.
          </ThemedText>
        </View>
