...
export const initializeDevData = async (): Promise<void> => {
  ...
  try {
    ...
    // LIDASHOP - Loja Teste CacaupIN
    const cacauprodutosStore: Store = {
      id: 'cacauprodutos-test',
      ownerId: 'demo_producer_001',
      name: 'CacauProdutos',
      description: 'Agropecuaria especializada em insumos para cacau, ferramentas e equipamentos',
      city: 'Uruara',
      state: 'PA',
      whatsapp: '(93) 99999-0099',
      email: 'contato@cacauprodutos.com',
      phone: '(93) 3333-0099',
      status: 'active',
      rating: 4.8,
      totalReviews: 24,
    ...
    const testProducts: Product[] = [
      {
        id: generateId(),
        storeId: 'cacauprodutos-test',
        name: 'Herbicida Seletivo - 5L',
        description: 'Controle de plantas daninhas em culturas de cacau. Eficácia comprovada.',
        category: 'herbicida',
        price: 185.90,
        discount: 15,
        quantity: 45,
        images: [],
        specifications: { 'Princípio Ativo': '2,4-D Amina', 'Concentração': '806 g/L' },
        active: true,
        createdAt: new Date().toISOString(),
        updatedAt: new Date().toISOString(),
      },
      {
        id: generateId(),
        storeId: 'cacauprodutos-test',
        name: 'Fungicida Cobre - 1L',
        description: 'Prevenção e combate a doenças fúngicas. Uso em cacau e café.',
        category: 'fungicida',
        price: 92.50,
        discount: 12,
        quantity: 60,
        images: [],
        specifications: { 'Cobre': '500 g/L', 'Formulação': 'Suspensão Concentrada' },
        active: true,
        createdAt: new Date().toISOString(),
        updatedAt: new Date().toISOString(),
      },
      {
        id: generateId(),
        storeId: 'cacauprodutos-test',
        name: 'Inseticida Orgânico - 500mL',
        description: 'Controle biológico de pragas do cacau. Seguro e ecológico.',
        category: 'inseticida',
        price: 68.00,
        discount: 8,
        quantity: 30,
        images: [],
        specifications: { 'Base': 'Neem', 'Concentração': '10 mL/L' },
        active: true,
        createdAt: new Date().toISOString(),
        updatedAt: new Date().toISOString(),
      },
      {
        id: generateId(),
        storeId: 'cacauprodutos-test',
        name: 'Adubo Foliar NPK 10-10-10 - 5L',
        description: 'Nutrição balanceada para desenvolvimento das plantas. Rápida absorção.',
        category: 'adubo',
        price: 78.90,
        discount: 20,
        quantity: 25,
        images: [],
        specifications: { 'NPK': '10-10-10', 'pH': '6.0-7.0' },
        active: true,
        createdAt: new Date().toISOString(),
        updatedAt: new Date().toISOString(),
      },
      {
        id: generateId(),
        storeId: 'cacauprodutos-test',
        name: 'Foice Agrícola 60cm',
        description: 'Ferramenta de qualidade para poda e limpeza. Lâmina resistente.',
        category: 'ferramenta',
        price: 145.00,
        discount: 18,
        quantity: 15,
        images: [],
        specifications: { 'Comprimento': '60 cm', 'Material': 'Aço Carbono' },
        active: true,
        createdAt: new Date().toISOString(),
        updatedAt: new Date().toISOString(),
      },
      {
        ...
        description: 'Tesoura de alta precisão com lâminas de aço inox. Ergonômica.',
        category: 'ferramenta',
        price: 89.90,
        discount: 22,
        quantity: 22,
        images: [],
        specifications: { 'Lâmina': 'Aço Inox', 'Comprimento': '20 cm' },
        active: true,
        createdAt: new Date().toISOString(),
        updatedAt: new Date().toISOString(),
      },
      {
        ...
        description: 'Corretivo de acidez do solo. Melhora pH e disponibilidade de nutrientes.',
        category: 'adubo',
        price: 35.50,
        discount: 0,
        quantity: 100,
        images: [],
        specifications: { 'Pureza': '90%', 'Granulação': 'Média' },
        active: true,
        createdAt: new Date().toISOString(),
        updatedAt: new Date().toISOString(),
      },
      {
        id: generateId(),
        storeId: 'cacauprodutos-test',
        name: 'Enxada Roçadeira',
        description: 'Ferramenta multifuncional para trabalhos agrícolas. Versátil e durável.',
        category: 'ferramenta',
        price: 55.00,
        discount: 14,
        quantity: 18,
        images: [],
        specifications: { 'Comprimento': '150 cm', 'Peso': '2.5 kg' },
        active: true,
        createdAt: new Date().toISOString(),
        updatedAt: new Date().toISOString(),
      },
