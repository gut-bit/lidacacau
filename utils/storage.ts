    ...
    const testProducts: Product[] = [
      {
        ...
        description: 'Controle de plantas daninhas em culturas de cacau',
        category: 'herbicida',
        price: 185.90,
        discount: 10,
        quantity: 45,
      ...
      },
      {
        ...
        description: 'Prevencao e combate a doencas fungicas',
        category: 'fungicida',
        price: 92.50,
        discount: 5,
        quantity: 60,
      ...
      },
      {
        id: generateId(),
        storeId: 'cacauprodutos-test',
        name: 'Inseticida Organico - 500mL',
        description: 'Controle biologico de pragas do cacau',
        category: 'inseticida',
        price: 65.00,
        discount: 0,
        quantity: 30,
      ...
      },
      {
        ...
        description: 'Nutricao balanceada para desenvolvimento das plantas',
        category: 'adubo',
        price: 78.90,
        discount: 8,
        quantity: 25,
      ...
      },
      {
        id: generateId(),
        storeId: 'cacauprodutos-test',
        name: 'Facao Agricola 60cm',
        description: 'Ferramenta de qualidade para poda e limpeza',
        category: 'ferramenta',
        price: 145.00,
        discount: 12,
        quantity: 15,
      ...
      },
      {
        ...
        description: 'Tesoura de alta precisao com lâminas de aco inox',
        category: 'ferramenta',
        price: 89.90,
        discount: 15,
        quantity: 22,
      ...
      },
      {
        id: generateId(),
        storeId: 'cacauprodutos-test',
        name: 'Calcario Agricola - 50kg',
        description: 'Corretivo de acidez do solo',
        category: 'adubo',
        price: 35.50,
        discount: 0,
        quantity: 100,
      ...
      },
      {
        ...
        description: 'Ferramenta multifuncional para trabalhos agrícolas',
        category: 'ferramenta',
        price: 55.00,
        discount: 10,
        quantity: 18,
